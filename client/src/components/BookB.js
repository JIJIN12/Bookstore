...
export default function BookB() {
    ...
    return (
        <div >
            ...
            <Link to={'/book/addbook'}> <button class="addbook_button" role="button">Addbook</button></Link>
            <div className="bookbgrid">
                ...
                <div className='col-lg-3 filter_book' >
                    ...
                    <h3>Genre</h3>
                    <input type='checkbox' value={'action'} name='action' onChange={bookgenre_input} />
                    <label className='book_label'>Action</label><br />
                    <input type='checkbox' value={'fantasy'} name='fantasy' onChange={bookgenre_input} />
                    <label className='book_label'>Fantasy</label><br />
                    <input type='checkbox' value={'fiction'} name='fiction' onChange={bookgenre_input} />
                    <label className='book_label'>Fiction</label><br />

                    <input type='checkbox' value={'romance'} name='romance' onChange={bookgenre_input} />
                    <label className='book_label'>Romance</label><br />

                    <input type='checkbox' value={'scifi'} name='scifi' onChange={bookgenre_input} />
                    <label className='book_label'>Sci-fi</label><br />
                    <input type='checkbox' value={'thriller'} name='thriller' onChange={bookgenre_input} />
                    <label className='book_label'>Thriller</label><br />


                    <h5>Availability</h5>
                    <input type='checkbox' />
                    <label className='book_label'>Stock available</label><br />

                    <input type='checkbox' />
                    <label className='book_label'>Out of stock</label><br /><br />
                                ...
                                <div className='col book_col'>
                                    <div className="card book_card" style={{ width: "18rem" }}>
                                        ...
                                        <div className="card-body book_card_body">
                                            ...
                                            <p className="card-text book_card_P">
                                                Description: {showFullDescriptions[data._id] ? data.bookdescription : `${data.bookdescription.slice(0, 200)}... `}
                                                {data.bookdescription.length > 200 && (
                                                    <a href="#toggle-description" onClick={() => setShowFullDescriptions(prevState => ({ ...prevState, [data._id]: !prevState[data._id] }))}>
                                                        {showFullDescriptions[data._id] ? "Show Less" : "Show More"}
                                                    </a>
                                                )}
                                            </p>
                                            ...
                                            <div className='d-flex justify-content-around mb-5 '>
                                                <h3 className='sub-book_h1'>
                                                    <a className='favourite fas fa-heart' onClick={() => { toggleColor(data._id) }}>
                                                    </a>
                                                </h3>
                                ...
                                <div className='col book_col'>
                                    <div className="card book_card" style={{ width: "18rem" }}>
                                        ...
                                        <div className="card-body book_card_body">
                                            ...
                                            <p className="card-text book_card_P">
                                                Description: {showFullDescriptions ? data.bookdescription : `${data.bookdescription.slice(0, 200)}...`}
                                            </p>
                                            {data.bookdescription.length > 200 && (
                                                <button className="btn btn-link" onClick={() => setShowFullDescriptions(!showFullDescriptions)}>
