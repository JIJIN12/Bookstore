...
export default function Profle() {
  ...
  useEffect(() => {
    axios
      .get("https://bookstore-7000.onrender.com/profile?userid=" + userid)
      .then((Response) => {
  ...
  const handleSectionClick = (section) => {
    if (section == "profile") {
      axios
        .get(
          "https://bookstore-7000.onrender.com/profile?userid=" + userid
          //  {
          //     headers: {
    ...
    if (section == "activity") {
      ...
      axios
        .get(
          "https://bookstore-7000.onrender.com/profile/activity?userid=" +
            userid
          //  {
          //     headers: {
          //         Authorization: `Bearer  ${Token}`
  ...
  const deleteprofile = () => {
    axios
      .get(
        `https://bookstore-7000.onrender.com/profile/deleteprofile/${userid}`
      )
      .then((response) => {
        console.log(response);
      });
      ...
      case "activity":
        return (
          <div className="activity_body">
            ...
            {/* <h1>works</h1> */}
            <h3 className="profile_text_h3">
              <b>Book uploaded</b>
            </h3>
            <p className="profile_text">
              Number of book uploaded:{activity_data.length}
            </p>
            <br />
            <h3 className="profile_text_h3">
              <b>Book Details</b>
      ...
      case "settings":
        return (
          <div>
            ...
            <button className="profile_edit btn btn-primary">Edit</button>
            <br />
            <br />
            <h3>Delete your Profile</h3>
            <buttton
              className="profile_delete btn btn_secondary"
    ...
    <div className="profile_body">
      ...
      <div className="prodile_heading row">
        ...
        <div className=" profile_logout">
          <button className="logout btn btn-success" onClick={Profilelogout}>
            Logout
          </button>
        </div>
      </div>
      <div className="profile-container">
        ...
        <div className="profile-data-display">{renderData()}</div>
      </div>
    </div>
  );
}
